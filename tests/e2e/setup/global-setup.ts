// import { type FullConfig, chromium } from "@playwright/test"; // Playwright not installed - E2E tests disabled
// import { DatabaseTestHelpers } from "../../utils/database-helpers";

// E2E global setup disabled - Playwright not installed
...
console.log("⚠️  E2E global setup disabled - Playwright not installed");
